...
static const uint16_t pAuxRamImage[] = {
    ...
    /*0x00E0*/ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x7002, 0x14D3, 0x0001, 0x0C67, 0xADB7, 0xF502, 
...
static void scifTaskResourceInit(void) {
    ...
    scifInitIo(5, AUXIOMODE_INPUT, 0, 0);
