/** \mainpage Driver Overview
  ...
  * - <b>Project file</b>:     C:/git/UofACapstone18_grp1_git/Sensor_CC1310_Node/sce/adc_sample.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2018-02-23 14:17:52.756
  ...
  * - ADC Sample:
  *     - <b>A: ADC input</b>: DIO28
  *     - <b>I: Digital Input</b>: DIO25
  *
  *
...
/// ADC Sample: temperature input
#define SCIF_ADC_SAMPLE_AUXIO_A_TEMP_INPUT 2
/// ADC Sample: motion input
#define SCIF_ADC_SAMPLE_AUXIO_D_MOTION_INPUT 5
...
#define SCIF_ADC_SAMPLE_DIO_A_AD_INPUT 28
/// ADC Sample I/O mapping: Digital Input
#define SCIF_ADC_SAMPLE_DIO_I_DIGITAL_INPUT 25
...
typedef struct {
    uint16_t adcValue;     ///< 
    uint16_t digitalValue; ///< digital Value
