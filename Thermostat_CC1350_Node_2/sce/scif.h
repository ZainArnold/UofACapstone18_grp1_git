/** \mainpage Driver Overview
  ...
  * - <b>Project file</b>:     C:/git/UofACapstone18_grp1_git/Thermostat_CC1350_Node_2/sce/adc_sample.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2018-03-31 19:18:12.516
  * - <b>Computer</b>:         ZAINZENBOOK
  * - <b>User</b>:             ZainLaptop
  *
  ...
  *     - <b>I: Digital Input 0</b>: DIO25
  *     - <b>I: Digital Input 1</b>: DIO26
  *     - <b>I: Digital Input 2</b>: DIO27
  *
  *
...
/// ADC Sample: bitshifting
#define SCIF_ADC_SAMPLE_D_FILTER_0 1
/// ADC Sample: bitshifting
#define SCIF_ADC_SAMPLE_D_FILTER_1 2
/// ADC Sample: bitshifting
#define SCIF_ADC_SAMPLE_D_FILTER_2 4
/// ADC Sample: number of digital inputs
#define SCIF_ADC_SAMPLE_D_INPUTNUM 3
/// ADC Sample: Number of bin thresholds
#define SCIF_ADC_SAMPLE_THRESHOLD_COUNT 6
/// ADC Sample I/O mapping: ADC input
#define SCIF_ADC_SAMPLE_DIO_A_AD_INPUT 23
/// ADC Sample I/O mapping: Digital Input
#define SCIF_ADC_SAMPLE_DIO_IDINPUT { 25, 26, 27 }
...
typedef struct {
    ...
    uint16_t pAuxioIDInput[3];  ///< I/O mapping: Digital Input
